...
public class ExecutorDelivery implements ResponseDelivery {
	...
	// private volatile ExecutorService mResponsePoster;
	...
	public void postResponse(Request<?> request, Response<?> response,
		...
		//TODO Volley      mResponsePoster.execute(new ResponseDeliveryRunnable(request, response, runnable));
		ExecutorService mResponsePoster = CommonThreadPoolFactory
				.getDefaultExecutor();
		// }
		request.markDelivered();
		request.addMarker("post-response");
		mResponsePoster.submit(new ResponseDeliveryRunnable(request, response,
				runnable));
	}
