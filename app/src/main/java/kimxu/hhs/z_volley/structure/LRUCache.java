...
public class LRUCache<K, V> {
	...
	/**
	 * Static library version of {@code android.util.LruCache}. Used to write
	 * apps that run on API levels prior to 12. When running on API level 12 or
	 * above, this implementation is still used; it does not try to switch to
	 * the framework's implementation. See the framework SDK documentation for a
	 * class overview.
	 */
