...
public class CacheDispatcher extends Thread {
	...
	private static final String DISPATCHER_NAME = "cache_dispatcher";
	...
	public void run() {
		...
		while (true) {
			try {
				...
				// L.x("http cache dispatcher","handle request",request.getOriginUrl());
