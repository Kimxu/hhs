...
import kimxu.hhs.z_volley.RetryPolicy;
...
//    private static int DEFAULT_POOL_SIZE = 4096;
    ...
    public BasicNetwork(HttpStack httpStack) {
        ...
        this(httpStack, ByteArrayPool.getInstance());
    }
        ...
        while (true) {
            ...
            try {
                ...
                if (statusCode == HttpStatus.SC_MOVED_PERMANENTLY || 
                	...
                	//L.e("Request at %s has been redirected to %s", request.getOriginUrl(), request.getUrl());
                } else {
                	//L.e("Unexpected response code %d for %s", statusCode, request.getUrl());
                }
...
//            L.v("HTTP response for request=<%s> [lifetime=%d], [size=%s], " +
...
//                    statusLine.getStatusCode(), request.getRetryPolicy().getCurrentRetryCount());
    ...
    protected void logError(String what, String url, long start) {
        ...
        //L.v("HTTP ERROR(%s) %d ms to fetch %s", what, (now - start), url);
    }
