package kimxu.hhs.z_volley.tools.client;
 ...
 * with reasonable default settings and registered schemes for Android, and also
 * lets the user add {@link HttpRequestInterceptor} classes. Don't create this
...
public final class CommonHttpClient implements HttpClient {
	...
	private static final String TAG = "AppChinaHttpClient";
	 ...
	 */
	public static CommonHttpClient newInstance(String userAgent, Context context) {
...
//				443));
	...
	private CommonHttpClient(ClientConnectionManager ccm, HttpParams params) {
		this.delegate = new HttpClient(ccm, params);
	}
	...
	final class HttpClient extends DefaultHttpClient {
		HttpClient(ClientConnectionManager conman, HttpParams params) {
			super(conman, params);
		}
	 ...
	 */
	@SuppressLint("NewApi") private static String toCurl(HttpUriRequest request, boolean logAuthToken)
			throws IOException {
